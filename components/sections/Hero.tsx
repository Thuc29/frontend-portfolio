  ...
  return (
    ...
    >
      ...
      <div className="flex w-full max-w-7xl flex-col items-center gap-8">
        ...
        <p
          ref={subtitleRef}
          className="max-w-3xl mt-6 text-center text-lg leading-relaxed text-beige-primary/90 md:text-xl lg:text-2xl"
          style={{ opacity: 1, visibility: 'visible' }}
        >
          <span>A</span> <span>passionate</span>{" "}
          <span className="relative inline-block font-black rounded-lg md:rounded-xl sm:text-xl md:text-2xl lg:text-3xl text-beige-dark bg-linear-to-r from-navy-light to-blue-analog px-4 py-1 shadow-lg transform hover:scale-105 hover:shadow-xl hover:shadow-blue-analog/20 transition-all duration-300 group cursor-pointer">
            <span className="relative z-10 group-hover:text-beige-light transition-colors duration-300">Frontend Developer</span>
          </span>{" "}
          <span>who</span> <span>loves</span> <span>building</span>{" "}
          <span className="font-bold text-olive-yellow bg-navy-primary/30 px-2 py-0.5 rounded-md border border-olive-yellow/30 hover:border-olive-yellow/60 hover:bg-olive-yellow/10 hover:scale-105 transition-all duration-300 cursor-pointer">
            beautiful
          </span>{" "}
          <span>and</span>{" "}
          <span className="font-bold text-purple-light bg-navy-primary/30 px-2 py-0.5 rounded-md border border-purple-light/30 hover:border-purple-light/60 hover:bg-purple-light/10 hover:scale-105 transition-all duration-300 cursor-pointer">
            responsive
          </span>{" "}
          <span>websites</span> <span>with</span> <span>modern</span>{" "}
          <span className="font-bold text-blue-analog bg-navy-primary/30 px-2 py-0.5 rounded-md border border-blue-analog/30 hover:border-blue-analog/60 hover:bg-blue-analog/10 hover:scale-105 transition-all duration-300 cursor-pointer">
            technologies
          </span><span>.</span>
        </p>
      ...
      >
        <div className="relative flex h-50 w-50 items-center justify-center rounded-full border border-beige-light/80 transition-all duration-500 ease-out hover:scale-50 group-hover:border-none group-hover:bg-navy-light ">
          {/* Down arrow icon */}
          <ArrowDown className="h-10 w-10 text-beige-primary transition-all duration-300 group-hover:text-beige-light group-hover:scale-110 group-hover:animate-bounce" />

          {/* Subtle glow effect */}
          <div className="absolute inset-0 rounded-full bg-beige-primary/10 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
        </div>
      </div>
    </section>
  )
